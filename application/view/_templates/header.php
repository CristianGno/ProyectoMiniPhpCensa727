...
<head>
  ...
  <title>Proyecto mini PHP - Censa</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="stylesheet" href="<?php echo URL ?>bootstrap/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo URL ?>bootstrap/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo URL ?>bootstrap/bower_components/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo URL ?>bootstrap/dist/css/AdminLTE.min.css">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?php echo URL ?>bootstrap/dist/img/<?php echo $_SESSION['USUARIO FOTO'] ?>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo URL ?>bootstrap/dist/img/<?php echo $_SESSION['USUARIO FOTO'] ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['USUARIO NOMBRE'], "_". $_SESSION['USUARIO ROL'] ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo URL ?>loginController/cerrarSesion" class="btn btn-default btn-flat">Cerrar Sesión</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo URL ?>loginController/registrarUsuario">Crear usuario</a></li>
            <li><a href="<?php echo URL ?>loginController/listarUsuarios">Listar usuarios</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
